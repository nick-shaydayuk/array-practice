...
#### Что проверяет эта практика?
   1. Понимание структуры массивов
   2. Знания и умения применять на практике циклы
   3. Практические нвыки использования функций reduce() и filter()
...
### Задание №2
Напишите функцию `alphaOmega()`, которая будет создавать новый массив, первый элемент которого будет равен первому у входящего массива, а второй - последнему.
...
### Задание №3
Напишите функцию `fill()`, которая будет принимать на вход число и элемент, а возвращать массив с таким количеством этих элементов, который указан передаваемым числом.
